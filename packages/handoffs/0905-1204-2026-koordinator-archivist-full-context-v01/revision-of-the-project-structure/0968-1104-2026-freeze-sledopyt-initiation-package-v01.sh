...
cat > "$DOC_DIR/0968-1104-2026-sledopyt-initiation-package-v01-success-log.md" <<'MD_EOF'
...
git -C "$REPO" add packages/core/sledopyt-v01
git -C "$REPO" commit -m "Add investigator initiation package v0.1"

echo "Created:"
echo "  $DOC_DIR/0968-1104-2026-sledopyt-initiation-package-v01-success-log.md"
echo
