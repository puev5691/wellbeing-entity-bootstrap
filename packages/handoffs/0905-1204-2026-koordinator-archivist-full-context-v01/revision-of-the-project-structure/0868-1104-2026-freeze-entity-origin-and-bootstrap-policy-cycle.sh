...
cat > "$DOC_DIR/0868-1104-2026-entity-origin-and-bootstrap-policy-success-log.md" <<'MD_EOF'
...
echo "Created:"
echo "$DOC_DIR/0868-1104-2026-entity-origin-and-bootstrap-policy-success-log.md"
