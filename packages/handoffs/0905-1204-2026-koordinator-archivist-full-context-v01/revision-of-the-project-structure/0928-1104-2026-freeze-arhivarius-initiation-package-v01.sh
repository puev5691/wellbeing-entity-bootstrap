...
cat > "$DOC_DIR/0928-1104-2026-arhivarius-initiation-package-v01-success-log.md" <<'MD_EOF'
...
git -C "$REPO" add packages/core/arhivarius-v01
git -C "$REPO" commit -m "Add archivist initiation package v0.1"

echo "Created:"
echo "  $DOC_DIR/0928-1104-2026-arhivarius-initiation-package-v01-success-log.md"
echo
