# KOO active Project Sources

Approved reference set for this initiation candidate:
...
Candidates/drafts are not promoted to active norm by this package.

---
entity: KOO
artifact_role: active-sources
status: initiation_candidate
